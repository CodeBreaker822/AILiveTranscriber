<div data-offline-model-dialog aria-hidden="true" class="pointer-events-none fixed inset-0 z-[60] hidden">
    ...
    <section data-offline-model-expanded role="dialog" aria-modal="true" aria-labelledby="offline-model-title" class="pointer-events-auto absolute left-1/2 top-1/2 flex max-h-[calc(100vh-2rem)] w-[min(92vw,30rem)] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-lg border border-white/10 bg-slate-950 p-4 text-slate-100 shadow-2xl sm:p-5">
        <div class="flex items-start justify-between gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-[0.62rem] font-semibold uppercase tracking-[0.24em] text-emerald-300">Offline transcription</p>
                    <h2 id="offline-model-title" class="mt-0.5 text-base font-semibold text-white" data-offline-model-title>Installing Whisper</h2>
                </div>
            </div>
        ...
        <p class="mt-3 text-xs leading-5 text-slate-300" data-offline-model-message>
            Preparing the Whisper large-v3-turbo Q8 download.
        </p>
