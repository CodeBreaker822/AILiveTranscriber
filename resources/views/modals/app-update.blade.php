<dialog data-app-update-dialog class="fixed inset-0 z-50 m-auto hidden w-[min(92vw,34rem)] rounded-lg border border-white/10 bg-slate-950 p-0 text-slate-100 shadow-2xl backdrop:bg-slate-950/85">
