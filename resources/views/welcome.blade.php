...
<x-app-layout title="Live Transcription | AI Transcriber" active-page="live">
    <div class="h-full min-h-0 overflow-hidden">
        <div class="grid h-full min-h-0 grid-rows-[1fr_auto] gap-3 lg:grid-cols-[1.35fr_0.65fr] lg:grid-rows-1">
            <section class="flex h-full min-h-0 flex-col overflow-hidden rounded-lg border border-white/10 bg-slate-950/70 shadow-[0_18px_60px_rgba(0,0,0,0.32)] backdrop-blur-xl">
