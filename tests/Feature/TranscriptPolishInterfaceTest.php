    ...
    public function test_live_and_upload_pages_use_desktop_sidebars_and_separate_modal_scripts(): void
    {
        foreach (['/', '/upload'] as $path) {
            ...
            $response
                ...
                ->assertSee('What should Gemini do?')
                ->assertSee('Instructions for Gemini')
                ...
                ->assertSee('DILG-Logo.png')
                ->assertSee('Department of the Interior and Local Government (DILG) Agusan del Sur. All rights reserved.')
