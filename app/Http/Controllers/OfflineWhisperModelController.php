...
{
    public function status(OfflineWhisperModelService $models): JsonResponse
    {
        return response()->json($models->status());
    }

    public function download(Request $request, OfflineWhisperModelService $models): StreamedResponse|JsonResponse
    {
        @set_time_limit(0);
