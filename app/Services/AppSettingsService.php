...
class AppSettingsService
{
    ...
    /**
     * @return array{mode: string, cpu_threads: int, memory_budget_mb: int, auto_cpu_threads: int, auto_memory_budget_mb: int, max_cpu_threads: int, max_memory_budget_mb: int, total_memory_mb: int, available_memory_mb: int}
     */
    ...
    public function setResourceProfile(string $mode, int $cpuThreads, int $memoryBudgetMb): void
    {
