...
use App\Http\Controllers\TranscriptExportController;
...
Route::post('/audio-uploads/sessions/process', [UploadSessionController::class, 'store'])->name('upload-sessions.process');
...
Route::post('/transcripts/export', [TranscriptExportController::class, 'store'])->name('transcripts.export');
